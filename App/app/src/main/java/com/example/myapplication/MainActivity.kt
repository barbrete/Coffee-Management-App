...
fun GerenciandoCafezinho(contexto : Context) {
    ...
    Column(
        ...
        Row(
            ...
            Button(
                onClick = {
                    var cafe = Cafe(estadoTextFieldId.text,estadoTextFieldNome.text,estadoTextFieldNota.text,
                        estadoTextFieldAroma.text.toInt() ,estadoTextFieldAcidez.text.toInt(),estadoTextFieldAmargor.text.toInt(),
                        estadoTextFieldSabor.text.toInt() , estadoTextFieldPreco.text.toDouble())
